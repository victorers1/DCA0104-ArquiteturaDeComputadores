#Primeira avaliação de Arquitetura de Computadores
	 .data
# Cada elemento é guardado linearmente na mem., como um vetor. Por isso, eles são acessados pelo seu índice no vetor
